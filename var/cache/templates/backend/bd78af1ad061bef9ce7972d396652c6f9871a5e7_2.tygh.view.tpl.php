...
/* Smarty version 4.1.1, created on 2024-01-01 23:14:35
  from '/Applications/XAMPP/xamppfiles/htdocs/cscart_v4.17.2_ru/design/backend/templates/views/settings_wizard/view.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_65931d2b00ac05_17729236',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bd78af1ad061bef9ce7972d396652c6f9871a5e7' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/cscart_v4.17.2_ru/design/backend/templates/views/settings_wizard/view.tpl',
      1 => 1701074501,
      2 => 'tygh',
    ),
  ),
...
function content_65931d2b00ac05_17729236 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/Applications/XAMPP/xamppfiles/htdocs/cscart_v4.17.2_ru/app/functions/smarty_plugins/block.component.php','function'=>'smarty_block_component',),1=>array('file'=>'/Applications/XAMPP/xamppfiles/htdocs/cscart_v4.17.2_ru/app/functions/smarty_plugins/block.inline_script.php','function'=>'smarty_block_inline_script',),));
...
<form name="settings_wizard_form" method="post" action="<?php echo htmlspecialchars((string) fn_url(''), ENT_QUOTES, 'UTF-8');?>
...
">
    ...
    <div id="settings_wizard">
        <input type="hidden" name="current_step" value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['current_step']->value, ENT_QUOTES, 'UTF-8');?>
">
...
/addons/<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['item']->value['addon_name'], ENT_QUOTES, 'UTF-8');?>
...
" >
                            ...
                            <td width="5%" data-th="&nbsp;">
                                <input type="hidden" name="addons[<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['item']->value['addon_name'], ENT_QUOTES, 'UTF-8');?>
]" value="N">
                                <label for="addon_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['item']->value['addon_name'], ENT_QUOTES, 'UTF-8');?>
" class="checkbox">
                                    <input id="addon_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['item']->value['addon_name'], ENT_QUOTES, 'UTF-8');?>
" type="checkbox" name="addons[<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['item']->value['addon_name'], ENT_QUOTES, 'UTF-8');?>
...
>
            ...
            Tygh.$('#settings_wizard').appear(function()<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['ldelim']->value, ENT_QUOTES, 'UTF-8');?>
Tygh.$.ceDialog('get_last').ceDialog('change_title', '<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['popup_title']->value, ENT_QUOTES, 'UTF-8');?>
